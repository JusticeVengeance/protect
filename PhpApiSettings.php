...
define("USERNAME", "justinvingeapi");
define("PASSWORD", "00326jvinge"); //pvc
define("INTEGRATOR_ID", "99999Grizzly"); //THIS GETS REPLACED IN OTHER FILES IN THIS DIRECTORY AS WELL. 
define("GRANT_TYPE","password");


define("BASE_URL","https://api.sandbox.paytrace.com"); //Production
